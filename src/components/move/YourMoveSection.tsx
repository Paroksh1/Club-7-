...
const AMENITIES = ["Play", "Compete", "Gather", "Create"];
...
function Headline() {
  return (
    <h2 className="-ml-1">
      <span className="block font-display text-display-2 uppercase leading-[0.92] text-c7-ink">The Court</span>
      <span className="-mt-1 block font-display text-display-2 uppercase leading-[0.92] text-c7-ink">
        Is Just the
      </span>
...
function HumanLine({ visible }: { visible: boolean }) {
  return (
    ...
    >
      Come for the game. Stay for everything around it.
    </p>
  );
}
  ...
  return (
    ...
    >
      <Image
        ...
        alt="CourtPlay's floodlit pickleball courts at night, Gurgaon"
        fill
        sizes="42vw"
        quality={90}
      ...
      <div className="relative z-10 shrink-0 border-t border-c7-line/10 bg-c7-bg-1 px-edge py-4 md:py-3">
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-6 sm:gap-y-1">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 font-body text-tag tracking-[0.2em] uppercase text-c7-ink-dim">
            <span className="text-c7-ink">CourtPlay</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="font-body text-[0.65rem] text-c7-ink-dim/40">© CourtPlay</span>
          </div>
        </div>
      </div>
    </section>
