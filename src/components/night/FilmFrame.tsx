...
/**
 * All five frames are representative stock photography here — the
 * stronger grade brings otherwise-unrelated photoshoots into one
 * consistent night register so the strip reads as one evening.
 */
...
export default function FilmFrame({ moment, visible, delay, orientation }: FilmFrameProps) {
  ...
  const overlayCaption = moment.overlay ? (
